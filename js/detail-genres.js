window.addEventListener('load', function () {
    ...
    console.log(idGet)
    let urlDeGeneros = `https://api.themoviedb.org/3/genre/${idGet}?api_key=5879ede367a1cc1dbb7ecaf35f419c29`;
    ...
    fetch(urlDeGeneros) //este fetch es lo que creo que esta mal pero no se que 
